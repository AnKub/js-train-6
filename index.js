...
const {name, age, address:{...address},} = personLarge;
...
function printKeysAndValues(obj) {
  for (key in obj) {
    ...
    // probably it works to console.log(Object.entries(obj));
}
...
console.log(carWrum(car)); // Виведе { brand: 'BMW', year: 2022, country: 'Unknown' }
